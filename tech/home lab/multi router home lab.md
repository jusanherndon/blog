...
# Lastly, the Ubiquiti EdgeSwitch
  ...
  I am adding a link to the [Openwrt Firmware selector](https://firmware-selector.openwrt.org/) to be able to easily see which devices are supported by OpenWrt
